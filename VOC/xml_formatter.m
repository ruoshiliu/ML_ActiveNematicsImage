...
%% neg
    for k2 = 1:num_neg
        size_neg = 100; % negative box size
...
%% pos_o
    for k3 = 1:num_pos_o
        size_pos_o = 120; % negative box size
...
%% nuc
    for k5 = 1:num_nuc
        size_nuc = 120; % negative box size
...
%% nucb
    ...
    filename = strcat('/Users/ruoshiliu/Desktop/OneDrive/Summer Project 2018/VOC_file/VOCdevkit_6c/VOC2007/Annotations/', name);
