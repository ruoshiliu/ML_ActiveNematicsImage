...
% Increase k
    ...
    if ~isempty(pts_pos(k).cdata)
        ...
        i = insertText(i, pts_pos(k).cdata(:,1:2), txt_pos, 'BoxColor', 'blue', 'TextColor', 'white','FontSize',5);
    end
...
%     end
    if ~isempty(pts_nuc(k).cdata)
        ...
        i = insertText(i, pts_nuc(k).cdata(:,1:2), txt_nuc, 'BoxColor', 'blue', 'TextColor', 'white','FontSize',5);
    end
%     if ~isempty(pts_nucb(k).cdata)
%         txt_nucb = pts_nucb(k).cdata(:,5);
%         i = insertText(i, pts_nucb(k).cdata(:,1:2), txt_nucb, 'BoxColor', 'blue', 'TextColor', 'white','FontSize',5);
%     end
